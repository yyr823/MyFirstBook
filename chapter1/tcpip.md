...
![](/assets/t1.png)[协议数据单元](https://baike.baidu.com/item/协议数据单元/8226389)PDU（Protocol Data Unit）是指对等[层次](https://baike.baidu.com/item/层次/424052)之间传递的数据单位。 协议数据单元\(Protocol Data Unit \)物理层的 PDU是
